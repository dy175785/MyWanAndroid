package com.haife.android.mcas.http.imageloader.glide;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.haife.android.mcas.http.imageloader.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.haife.android.mcas.http.imageloader.glide.GlideOptions().apply(toSet));
    }
  }
}
